...
@interface WTMasterViewController ()
...
- (void)viewDidLoad
{
    ...
    self.detailViewController = (WTDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}

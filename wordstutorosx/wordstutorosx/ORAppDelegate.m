...
// Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.olegr.wordstutorosx" in the user's Application Support directory.
